        ...
        if (1 == gpphTmlNfc_Context->tReadInfo.bEnable)
        {
            ...
            if (NFCSTATUS_INVALID_DEVICE != (uintptr_t)gpphTmlNfc_Context->pDevHandle)
            {
                ...
                else
                {
                    ...
                    NXPLOG_TML_D("PN54X - Read successful.....");
    ...
    while (gpphTmlNfc_Context->bThreadDone)
    {
        ...
        if (1 == gpphTmlNfc_Context->tWriteInfo.bEnable)
        {
            ...
            if (NFCSTATUS_INVALID_DEVICE != (uintptr_t)gpphTmlNfc_Context->pDevHandle)
            {
                ...
                NXPLOG_TML_D("PN54X - Invoking Write.....");
                ...
                if (-1 == dwNoBytesWrRd)
                {
                    if (getDownloadFlag() == TRUE)
                    {
                        ...
                        {
                            NXPLOG_NCIHAL_E(
                                    "PN54X - Error in Write  - Retry 0x%x", retry_cnt);
                            goto retry;
                        }
                    }
                    NXPLOG_TML_E("PN54X - Error in Write.....");
                ...
                {
                    NXPLOG_TML_D("PN54X - Write successful....");
